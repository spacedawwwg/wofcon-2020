<template>
  <div class="home">
    ...
    <ul class="mb-4">
      ...
      <li>
        Sneak peeks of upcoming Mantic releases and more (trust us there is some
...
<script>
  export default {
    name: 'home',
    metaInfo: {
      title: 'WOFCON 2020 - A Mantic Weekend Gaming Event',
      htmlAttrs: {
        lang: 'en',
        amp: true
      },
      meta: [
        ...
        {
          property: 'og:url',
          content: 'https://wofcon2020.weightoffire.com/'
        },
        { property: 'og:title', content: 'Welcome to WOFCON 2020' },
        { property: 'og:site_name', content: 'WOFCON 2020' },
        { property: 'og:type', content: 'website' },
        {
          property: 'og:image',
          content: 'https://wofcon2020.weightoffire.com/wofcon2020-ograph.jpg'
        },
        {
...
<style scoped>
  ...
  .sponsors__sponsor--deepcutstudios img {
    max-height: 90px;
  }

  .sponsors__sponsor--gamemateu img {
    max-height: 110px;
  }

  .sponsors__sponsor--krmulticase img {
    max-height: 110px;
  }

  .sponsors__sponsor--kromlech img {
    max-height: 120px;
  }
</style>
